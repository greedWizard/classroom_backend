...
class ProjectSettings(BaseModel):
    ...
    FRONTEND_OAUTH_URL: str = env('FRONTEND_OAUTH_URL')
    ...
    NOTIFICATIONS_BASE_URL = env('NOTIFICATIONS_BASE_URL')
    NOTIFICATIONS_REGISTRATION_SUCCESS_URI = (
        env('NOTIFICATIONS_REGISTRATION_SUCCESS_URI', default='')
    )
    NOTIFICATIONS_PASSWORD_RESET_URI = (
        env('NOTIFICATIONS_PASSWORD_RESET_URI', default='')
    )
