...
async def test_assign_homework_host(
    ...
    assert json_data == {
        'detail': {
            'assigned_room_post_id': "Teacher's can not assign homeworks.",
        },
    }, json_data
...
async def test_assign_homework_not_participant(
    ...
    assert json_data == {
        'detail': {
            'assigned_room_post_id': 'Incorrect post id.',
        },
    }, json_data
...
async def test_assign_homework_duplicate(
    ...
    assert json_data == {
        'detail': {
            'assigned_room_post_id': 'Homework is already assigned by this user.',
        },
    }, json_data
